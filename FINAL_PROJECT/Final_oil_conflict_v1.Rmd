...
**Detail your datasets and describe final data.**

The study focuses on eight Middle Eastern countries and uses geospatial datasets on oil infrastructure, populated places (cities), and conflict events.

All spatial data are projected to a common coordinate reference system (EPSG:3857) to ensure accurate distance calculations. Conflict data are restricted to events occurring from 2010 onwards to maintain temporal consistency.
...
At the 30 km threshold, cities located near oil infrastructure exhibit lower average distances to conflict events compared to those located farther away (approximately 75.6 km vs. 83.6 km). This suggests a modest spatial difference at shorter distances.

At the 60 km threshold, the difference becomes substantially larger. Cities near oil infrastructure are, on average, located significantly closer to conflict events (approximately 69.6 km vs. 92.7 km).

This pattern indicates that the spatial association between oil infrastructure and conflict is more clearly observable when broader geographic definitions of proximity are considered.

Importantly, these results reflect differences in spatial distribution rather than direct relationships, and should be interpreted as descriptive patterns.

## Conflict Proximity to Oil Infrastructure

The distribution of distances from conflict events to oil infrastructure shows that conflict typically occurs within a regional range of oil-related locations.
The median distance is approximately 81 km, with an average close to 88 km, indicating that while some events occur near infrastructure, many are located at moderate distances.
